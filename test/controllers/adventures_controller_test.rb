...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference("Adventure.count") do
      post adventures_url, params: { adventure: { description: @adventure.description, player_id: @adventure.player_id, ruleset: @adventure.ruleset, setting: @adventure.setting, status: @adventure.status, title: @adventure.title, type: @adventure.type } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { description: @adventure.description, player_id: @adventure.player_id, ruleset: @adventure.ruleset, setting: @adventure.setting, status: @adventure.status, title: @adventure.title, type: @adventure.type } }
