...
class AdventuresTest < ApplicationSystemTestCase
  ...
  test "should create adventure" do
    ...
    fill_in "Player", with: @adventure.player_id
    fill_in "Ruleset", with: @adventure.ruleset
    fill_in "Setting", with: @adventure.setting
    check "Status" if @adventure.status
    fill_in "Title", with: @adventure.title
    fill_in "Type", with: @adventure.type
